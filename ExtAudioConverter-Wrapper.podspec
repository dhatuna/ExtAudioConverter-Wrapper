...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of ExtAudioConverter-Wrapper.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/jk-gna/ExtAudioConverter-Wrapper'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'jk-gna' => 'junq.jeon@gmail.com' }
  s.source           = { :git => 'https://github.com/jk-gna/ExtAudioConverter-Wrapper.git', :tag => s.version.to_s }
